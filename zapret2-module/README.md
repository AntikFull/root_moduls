...
При обновлении старые записи `apps.list`, которые уже покрываются новым AUTO-каталогом, удаляются как дубли. Фактический выбор не меняется, потому что AUTO включн по умолчанию.
