### v2.0.1 - 08.08.2026
* Удалён пустой каталог `zygisk`, из-за которого Magisk ошибочно определял Zapret2 как несовместимый Zygisk-модуль.
* Zygisk не требуется: модуль работает через `service.sh`, `nfqws2`, Lua и iptables.
