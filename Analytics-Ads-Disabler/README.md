...
- 🛡️ **Блокировка рекламы и трекинга:** Отключение рекламных ресиверов и служб сбора данных (Yandex Metrica, Google Analytics, Firebase, AppMetrica и др.).
...
- 🛡️ **Ad & Telemetry Disabler:** Neutralizes analytics/tracking components (Google Analytics, Firebase, AppMetrica, Yandex Metrica, etc.).
