# Analytics & Ads Disabler v6.1.2

> **v6.1.2:** Полная совместимость с банковскими приложениями и защитой от Zygisk-детекторов (гарантированная выгрузка через `dlclose`), прямая интеграция белых списков в Zygisk-движок, устранение зацикливания `SIDE-EFFECTS-PENDING` и отказоустойчивый Multi-User инвентарь.
