# Analytics & Ads Disabler v6.1.3

> **v6.1.3:** Строгий целевой Opt-In режим Zygisk (полная изоляция браузеров, банков и системных приложений), исправление ложных срабатываний закрытия Activity в AadCore, безопасные сигнатуры View-Collapse и гарантированная совместимость с NeoZygisk/Zygisk.
