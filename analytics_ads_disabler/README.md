# Analytics & Ads Disabler v6.1.0

> **v6.1.0:** Безопасный порядок верификации пакета перед установкой (проверка integrity до любых мутаций данных), автоматический пересчет SHA-256 манифеста, критические исправления инвентаря путей APK, универсальная поддержка Multi-App/User ID и стабильная работа белых списков.
