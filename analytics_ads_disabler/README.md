# Analytics & Ads Disabler v6.1.9

> **v6.1.9:** Автоматическое объединение и удаление папок-дубликатов в `/data/adb/`, исправление бага `RESTORE -> disabled`, строгий Opt-In для Zygisk.
