# Analytics & Ads Disabler v6.1.4

> **v6.1.4:** Универсальная работа во всех приложениях без списков исключений, точное распознавание рекламных SDK (`KNOWN_AD_ACTIVITIES`), безопасный View-Collapse без скрытия родительских контейнеров и устранение layout-зацикливаний.
