# Analytics & Ads Disabler v6.1.8

> **v6.1.8:** Исправление бага ложного сохранения состояния `RESTORE -> disabled`, принудительное разблокирование провайдеров в `customize.sh`, строгий Opt-In для Zygisk (полная изоляция браузеров и банков).
