# Analytics & Ads Disabler v6.1.5

> **v6.1.5:** Автоматическая выгрузка Zygisk из DenyList/Shamiko (Яндекс Пей, банки), полная изоляция рендереров Chromium (Brave, Chrome, Edge) и отключение блокировки DoH по умолчанию.
