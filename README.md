...
| :--- | :--- | :--- | :--- |
| **[zapret2-android](./zapret2-android)** | `v3.2.26` | Системный обход DPI-блокировок (YouTube 4K, Discord, сайты) на базе `nfqws2`/`tpws` + точечный туннель для любых приложений. Работает на уровне ядра: 0% оверхеда по батарее, поддержка обхода на раздаче (Hotspot/Wi-Fi). | Magisk / KernelSU / APatch (Android 7–16) |
...
1. **[zapret2-android](./zapret2-android) (v3.2.26)**
...
| :--- | :--- | :--- |
| **zapret2-android v3.2.26** | [zapret2-android_v3.2.26_3146.zip](https://raw.githubusercontent.com/AntikFull/root_moduls/main/releases/zapret2-android_v3.2.26_3146.zip) | ~24 MB |
