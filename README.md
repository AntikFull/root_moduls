...
| **[analytics_ads_disabler](./analytics_ads_disabler)** | `v5.7.0` | Комплексная блокировка рекламы, аналитики и трекеров + нативный Zygisk Auto-Collapse, Unity IL2CPP Native Hooking, Pre-Load Spoofing (isReady=true) & Rewarded Ads Spoofing. | Magisk 20.4+ / KernelSU / APatch |
...
2. **[analytics_ads_disabler](./analytics_ads_disabler) (v5.7.0)**
   - Systemwide native component disabler + built-in native Zygisk Auto-Collapse, Unity IL2CPP Native Hooking, Pre-Load Spoofing (isReady=true) & Rewarded Ads Spoofing.
...
| **analytics_ads_disabler v5.7.0** | [analytics_ads_disabler_v5.7.0_5700.zip](https://raw.githubusercontent.com/AntikFull/root_moduls/main/releases/analytics_ads_disabler_v5.7.0_5700.zip) | ~449 KB |
